...
`define INPUT_FILE              "C:/Users/USER/Desktop/PA1/TESTBED_v1/test_patterns/CompBoothMultiplier_in.dat"
`define OUTPUT_FILE             "C:/Users/USER/Desktop/PA1/TESTBED_v1/test_patterns/CompBoothMultiplier_out.dat"

`define NUM_TEST_PATTERN        3

module tb_CompBoothMultiplier;
    ...
    // design instantiation (Booth)
    CompBoothMultiplier DUT (
        .clk            (clk            ),
        .rst_n          (rst_n          ),
        .start          (start          ),
        ...
        begin
            ...
            if (product !== golden) begin
                ...
                $display("[FAILED] %0d * %0d = %0d (expect %0d). Please check your design.",
                          $signed(a), $signed(b), $signed(product), $signed(golden));
            end else begin
                pass_cnt = pass_cnt + 1;
                $display("[PASS] %0d * %0d = %0d",
                          $signed(a), $signed(b), $signed(product));
            end
